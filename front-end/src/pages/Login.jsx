  ...
  return (
    <form onSubmit={onSubmitHandler}
      ...
      <div className='w-full flex justify-between text-sm mt-[-8x]'>
        ...
        {
          currentState === 'Login' ? <p onClick={() => setCurrentState('Sign Up')} className='cursor-pointer'>New User?</p> :
            <p onClick={() => setCurrentState('Login')} className='cursor-pointer'>Existing User?</p>
        }
      </div>
